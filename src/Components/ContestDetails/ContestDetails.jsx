...
const ContestDetails = () => {
    ...
    const { title, description, startDate, endDate, location, rules, prizes, image} = contestDetail;
        ...
        <div>
            <div className="hero min-h-screen bg-opacity-90 bg-fixed " style={{backgroundImage: `url(${bannerBg})`}}>
                ...
                <div className="my-24 py-14 text-slate-800 rounded-lg text-lg bg-red-50 bg-opacity-10">
                    <div className="hero ">
                        <div className="hero-content p-16 flex-col lg:flex-row">
                            <div className="lg:w-1/2">
                                <img src={image} className="w-9/12 rounded-lg shadow-2xl" />
                            </div>
